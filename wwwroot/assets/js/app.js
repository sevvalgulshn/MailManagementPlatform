$(function () {
	...
	$(function () {
		if ($.fn && $.fn.metisMenu && $('.metismenu-card').length) {
	...
	$(function () {
		if ($.fn && $.fn.metisMenu && $('.card-collapse').length) {
	...
	// metismenu
	$(function () {
		if ($.fn && $.fn.metisMenu && $('#menu').length) {
			$('#menu').metisMenu();
		}
...
/* perfect scroll bar (safe + correct) 
if (typeof PerfectScrollbar !== "undefined") {
	const msgList = document.querySelector(".header-message-list");
	if (msgList) new PerfectScrollbar(msgList);

	const notifList = document.querySelector(".header-notifications-list");
	if (notifList) new PerfectScrollbar(notifList);
}
*/
